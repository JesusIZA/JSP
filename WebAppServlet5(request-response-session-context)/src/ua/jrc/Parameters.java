...
@WebServlet(urlPatterns="/Parameters", loadOnStartup=0)//0 nomer servleta(1,2...)
public class Parameters extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	//request, response - створюються нові для кожного запиту
	//session - створюється нова для кожного браузеру
	//context - створюэться одне для кожного сервлету
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href='http://localhost:8080/WebAppServlet/parameters.html'>Come Back</a><br>");
		out.close();
